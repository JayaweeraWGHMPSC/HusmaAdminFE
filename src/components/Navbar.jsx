        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="flex flex-col">
              <h1 className="font-bold text-[#0067bc] tracking-wide text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl">
                HUSMA
              </h1>
              <span className="text-gray-600 font-medium text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl -mt-1 sm:-mt-2">
                ENGINEERING
              </span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-3">
            ...
            <button
              ...
              className={`inline-flex items-center px-2 py-2 lg:px-3 border text-xs font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
                currentPage === 'project'
            ...
            <button
              ...
              className={`inline-flex items-center px-2 py-2 lg:px-3 border text-xs font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 ${
